...
public enum gifLoaderError: Error{
    
    case failToReturnImageFrame
    case unKnownError
    
    public var localizedDescription: String {
        switch self {
        case .failToReturnImageFrame:
            return "Gif Image Frame can not return"
        case .unKnownError:
            return "Some unknown error accure"
        }
    }
...
public enum MetalCameraSessionError: Error {
    ...
    case failedToAddDepthaDataOutput
    ...
    public var localizedDescription: String {
        switch self {
        case .failedToAddDepthaDataOutput:
            return "Failed to add depth data to AVCapture Session!"
        case .noHardwareAccess:
